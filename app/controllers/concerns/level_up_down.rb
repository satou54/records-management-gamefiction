module LevelUpDown
  ...
  def levelUpAndDown(task_id, action_day, action)
    ...
    after_experience_point_percent = ((after_total_experience_point - after_level_required_experience_point).to_f / (next_level_required_experience_point - after_level_required_experience_point).to_f * Common::PERCENT).floor
